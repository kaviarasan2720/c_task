        ...
        <CRow>
            ...
            <CIcon icon={cilSearch} size="lg" />
                ...
                <CCol md={6}>
                    ...
                    <Link to="/lead/create"><li><CIcon icon={plus} customClassName="nav-icon"/><div>Add Lead</div></li></Link>
            ...
            <CTable align="middle" className="mb-0" border responsive>
                ...
                <CTableBody className='leadbodycolor'>
                    <CTableRow v-for="item in tableItems">
                      ...
                      <Link to="/lead/edit"><div className='svgeditwidth editbox'><CIcon icon={edit} customClassName="nav-icon" /></div></Link>
