...
function Lead_raw_upload() 
{
    ...
    <>
            ...
            <div className="mb-3 leadboxdesign">
                ...
                <div className="form-group col-md-12 margintop4">
                    <label htmlFor="images" className="drop-container">
                        <span className="drop-title">Download template to import applications</span>
      ...
      <CCol md={6}>
            <div className="mb-3 leadboxdesign">
                <CFormLabel htmlFor="exampleFormControlInput1"><div className='downloadbox'>
                    <CIcon icon={upload_white} customClassName="nav-icon"/></div><div className='template'>Upload Applications</div> </CFormLabel>
                <div className="form-group col-md-12 margintop4">
                    <label htmlFor="images" className="drop-container">
