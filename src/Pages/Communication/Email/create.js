...
function Communication_email_create() 
{
    document.title="Email Create | CRM 42andmore";
    ...
    const handleSubmit = (event) => {
        ...
        const apiUrl= API +'email/createemail';
        ...
        {
            toast.success('Email Created Successfully...', {position: "top-right",autoClose: 1500,hideProgressBar: false,closeOnClick: true,pauseOnHover: true,draggable: true,progress: undefined,theme: "colored",});
...
export default Communication_email_create;