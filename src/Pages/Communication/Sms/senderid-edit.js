...
function Communication_sms_senderid_edit() 
{
    ...
    const handleSubmit = (event) => {
        ...
        const apiUrl= API +'senderid/updatesenderid';
        const myHeaders = new Headers();
        myHeaders.append('Content-Type', 'application/json');
        var raw = JSON.stringify({
              "userId": localStorage.getItem('UserId'),
        ...
        if(result.status===200)
        {
            toast.success('Sender Id Updated Successfully...', {position: "top-right",autoClose: 1500,hideProgressBar: false,closeOnClick: true,pauseOnHover: true,draggable: true,progress: undefined,theme: "colored",});
