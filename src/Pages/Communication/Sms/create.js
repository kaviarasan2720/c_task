...
function Communication_sms_create() 
{
    document.title="SMS Create | CRM 42andmore";
    useEffect(() => {
        allsenderlist();
        }, []);
    ...
    const handleSubmit = (event) => {
        ...
        const apiUrl= API +'sms/createsms';
        ...
        {
            toast.success('SMS Created Successfully...', {position: "top-right",autoClose: 1500,hideProgressBar: false,closeOnClick: true,pauseOnHover: true,draggable: true,progress: undefined,theme: "colored",});
            setTimeout(() => navigate(-1), 2000);
        }
        else{
            toast.error('Error in adding SMS...', {position: "top-right",autoClose: 1500,hideProgressBar: false,closeOnClick: true,pauseOnHover: true,draggable: true,progress: undefined,theme: "colored",});
        }
      },
      (error)=>{}
      )
...
export default Communication_sms_create;