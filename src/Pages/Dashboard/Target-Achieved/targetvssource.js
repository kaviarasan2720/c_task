...
const Targetvssource = () => {
    ...
    const [options,setoptions] = useState({
        ...
        xaxis: {
          categories: ['Careers360', '42andmore', 'Shiksha', 'Whatsapp', 'College dekho', 'SMS '],
        }
      });
    ...
    <CRow>
      <CCol sm={5}>
          <h4 id="traffic" className="card-title mb-0">
            <div className='deviceperformancebutton'>Target Vs Source</div>
          </h4>
      </CCol>
